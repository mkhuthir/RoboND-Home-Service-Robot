...
xterm -e "export ROBOT_INITIAL_POSE='-x -4.0 -y 4.0 -Y -1.57079633' && roslaunch turtlebot_gazebo turtlebot_world.launch world_file:=$HOME/catkin_ws/src/World/personal.world" &
sleep 5
